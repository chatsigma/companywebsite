    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#25D366] to-[#006AFF] text-white rounded-full font-semibold">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
            <div className="w-16 h-16 bg-gradient-to-br from-[#25D366] to-[#1da851] rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 text-center hover:shadow-xl transition-shadow duration-300">
            <div className="w-16 h-16 bg-gradient-to-br from-[#006AFF] to-[#0052CC] rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        {/* Notify Me Section */}
        <div className="bg-gradient-to-r from-[#25D366] to-[#006AFF] rounded-3xl p-12 text-white text-center">
