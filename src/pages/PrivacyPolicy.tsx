      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 md:p-12 mb-8 hover:shadow-2xl transition-shadow duration-300">
          ...
          <div className="mb-6 ml-18">
            ...
            <p className="mt-6 p-4 bg-blue-50 rounded-xl border-l-4 border-[#1877F2]">
              <strong className="text-[#1877F2]">Communication Consent:</strong> We collect personal details like your name, email address, and phone number etc. By sharing your information, you authorize ChatSigma to contact you via SMS, RCS, WhatsApp, Email, and other communication channels. This consent overrides any NDNC/DND registration as per TRAI regulations.
            </p>
          </div>
