    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-red-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-16">
          <h2 className="text-3xl font-bold text-gray-900 mb-8 text-center">Real Estate Use Cases</h2>
        ...
        <div className="bg-gradient-to-r from-orange-600 to-red-600 rounded-2xl p-12 text-white text-center">
          ...
          <button className="px-8 py-4 bg-white text-orange-600 rounded-lg font-semibold hover:bg-gray-50 transition-colors transform hover:scale-105 flex items-center mx-auto">
            Get Started Today
