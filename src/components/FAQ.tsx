      ...
      <div className="max-w-4xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-8 md:mb-12">
          <div className="relative inline-block mb-4 sm:mb-6">
            <div className="w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-[#25D366] rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center mx-auto transform hover:scale-110 transition-transform duration-300">
        ...
        <div className="space-y-2 sm:space-y-3">
          {faqs.map((faq, index) => (
            <div
              key={index}
              className={`group bg-gray-50 rounded-lg sm:rounded-xl md:rounded-2xl overflow-hidden hover:shadow-md sm:hover:shadow-lg transition-all duration-500 border-l-2 sm:border-l-4 ${
            ...
            >
              ...
              >
                <div className="flex items-center space-x-2 sm:space-x-3 md:space-x-4 flex-1 min-w-0">
                  <div className={`w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 rounded-md sm:rounded-lg md:rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0 ${
                    openItems.includes(index) ? 'bg-[#25D366]/20' : 'bg-gray-100'
                  }`}>
              ...
              {openItems.includes(index) && (
                <div className="px-3 sm:px-4 md:px-8 pb-3 sm:pb-4 md:pb-5 animate-slide-down">
                  <div className="pl-8 sm:pl-12 md:pl-16">
                    <div className="h-px bg-[#25D366]/30 mb-2 sm:mb-3 md:mb-4"></div>
        ...
        <div className="mt-6 sm:mt-8 md:mt-12 text-center">
          <div className="relative inline-block mb-4 sm:mb-6">
            <div className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 bg-[#25D366] rounded-lg sm:rounded-xl md:rounded-2xl flex items-center justify-center mx-auto">
          ...
          <div className="bg-gray-50 rounded-lg sm:rounded-xl md:rounded-2xl p-4 sm:p-6 md:p-8 border border-gray-100">
