...
const SEOHead: React.FC<SEOHeadProps> = ({
  ...
  image = "https://chatsigma.com/cs_logo_web-removebg-preview.png",
  ...
  const defaultSchemaData = {
    ...
    "url": "https://chatsigma.com",
    "logo": "https://chatsigma.com/cs_logo_web-removebg-preview.png",
      ...
      <script type="application/ld+json">
        {JSON.stringify({
          ...
          "publisher": {
            ...
            "logo": {
              "@type": "ImageObject",
              "url": "https://chatsigma.com/cs_logo_web-removebg-preview.png"
            }
          }
        })}
      </script>
